...
<?
		...
		default:
			...
			?><input size="30" type="text" id="<?=$FIELD?>_f_fiz" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" /><?
...
<?if($arResult["USER_PROPERTIES"]["SHOW"] == "Y"):?>
	...
	<tr id="<? echo $arUserField['FIELD_NAME'];?>_fiz"><td><?=$arUserField["EDIT_FORM_LABEL"]?>:<?if ($arUserField["MANDATORY"]=="Y"):?><span class="starrequired">*</span><?endif;?></td><td>
			<?$APPLICATION->IncludeComponent(
